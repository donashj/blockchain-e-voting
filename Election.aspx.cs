...
namespace Project
{
    public partial class Election : System.Web.UI.Page
    {
        ...
        {
            string q = "Select Candidate1,Candidate2,Candidate3,Candidate4,EId,VoteDate from Election where Election='" + ddlelections.SelectedValue + "'";
            SqlDataAdapter da = new SqlDataAdapter(q, con);
            DataSet ds = new DataSet();
            da.Fill(ds);
            int c = ds.Tables[0].Rows.Count;
            ...
            {                
                ...
                if(ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    lbage1.Text = ds.Tables[0].Rows[0][2].ToString();;
                    lbqualification1.Text = ds.Tables[0].Rows[0][3].ToString();
                }
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    lbage2.Text = ds.Tables[0].Rows[0][2].ToString(); ;
                    lbqualification2.Text = ds.Tables[0].Rows[0][3].ToString();
                }
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    lbage3.Text = ds.Tables[0].Rows[0][2].ToString(); ;
                    lbqualification3.Text = ds.Tables[0].Rows[0][3].ToString();
                }
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    lbage4.Text = ds.Tables[0].Rows[0][2].ToString(); ;
                    lbqualification4.Text = ds.Tables[0].Rows[0][3].ToString();
                }
